...
This workshop is designed to teach you some of the basics of F# and Functional Programming by combining theory ([slides](FSharpIntroWorkshop_Slides.pdf)) and practice ([exercises](FSharpIntroWorkshop_Exercises.pdf)).
